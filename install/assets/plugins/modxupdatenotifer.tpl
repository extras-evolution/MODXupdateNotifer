 ...
 * @internal    @properties &showButton=Show Update Button:;menu;show,hide,AdminOnly;AdminOnly &version=Version:;menu;auto,modxcms/evolution,dmi3yy/modx.evo.custom;auto &type=Type:;menu;tags,releases;tags 
