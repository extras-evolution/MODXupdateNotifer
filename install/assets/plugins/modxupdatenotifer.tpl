...
$output = '';
        ...
        $message = !empty($message) ? $modx->getChunk($message) : '<div style="font-size:20px;color:red;">Система управления сайтом устарела - возможны проблемы с безопасностью. Для обновления обратитесь к разработчикам сайта.</div>';
